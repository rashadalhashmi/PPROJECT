        ...
        638: function(e) {
            ...
            function i(e, t) {
                ...
                var i = setInterval((function() {
                    ...
                    !t.once && t.pulse && (e.setAttribute("data-purecounter-duration", 0),
                    setTimeout((function() {
            ...
            function u(e, t) {
                ...
                function(e, t) {
                    if (!t.separator)
                        return e.replace(new RegExp(/,/gi,"gi"), "");
                    var r = "string" == typeof t.separator ? t.separator : ",";
                    return e.replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,").replace(new RegExp(/,/gi,"gi"), r)
                }(e.toLocaleString(void 0, r), t)
            }
            function c(e) {
